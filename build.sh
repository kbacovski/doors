...
/usr/libexec/PlistBuddy -c 'Add :CFBundleShortVersionString string 2.6' "$CONTENTS/Info.plist"
/usr/libexec/PlistBuddy -c 'Add :CFBundleVersion string 8' "$CONTENTS/Info.plist"
